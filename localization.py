...
# Phiên bản 3.0 - Cập nhật văn bản cho nút hành động chính
...
class Translator:
    def __init__(self):
        self.language_data = {
            "vi": {
                "window_title": "Excel File Batch Processing Toolkit",
                ...
                "save_rename": "Lưu đổi tên",
                "save_rename_prefix": "Tiền tố",
                "save_rename_suffix": "Hậu tố",
                ...
                "run_button": "XỬ LÝ CÁC FILE ĐÃ CHỌN",
                "language_label": "Ngôn ngữ:",
                "tasks_dialog_title": "Chọn tác vụ",
                "tasks_dialog_label": "Vui lòng chọn các tác vụ để xử lý:",
                "task_add_label": "Dán nhãn (Add Label)",
                "task_add_label_option_label": "Nội dung nhãn:",
                ...
                "task_set_print_settings": "Thiết lập trang in",
                ...
                "engine_spire": "Spire.Xls (Ổn định)",
                ...
                "input_folder_label": "Thư mục nguồn:",
                "output_folder_label": "Thư mục đích:",
                "open_folder_hover_label": "Mở thư mục",
                "category_cleanup": "Dọn dẹp Workbook",
                "category_optimization": "Tối ưu hóa dung lượng",
                "category_utilities": "Định dạng & Tiện ích khác",
            },
            "en": {
                "window_title": "Excel File Batch Processing Toolkit",
                ...
                "save_rename": "Save with new name",
                "save_rename_prefix": "Prefix",
                "save_rename_suffix": "Suffix",
                ...
                "task_set_print_settings": "Set Print Settings",
                ...
                "log_level_info": "Info",
                "log_level_debug": "Debug",
                "input_folder_label": "Source folder:",
                "output_folder_label": "Destination folder:",
                "open_folder_hover_label": "Open folder",
                "category_cleanup": "Workbook Cleanup",
                "category_optimization": "Size Optimization",
                "category_utilities": "Formatting & Other Utilities",
            },
            "ja": {
                "window_title": "Excel File Batch Processing Toolkit",
                ...
                "save_rename": "名前を付けて保存",
                "save_rename_prefix": "接頭辞",
                "save_rename_suffix": "接尾辞",
                ...
                "log_level_info": "Info",
                "log_level_debug": "Debug",
                "input_folder_label": "ソースフォルダー:",
                "output_folder_label": "宛先フォルダー:",
                "open_folder_hover_label": "フォルダーを開く",
                "category_cleanup": "ワークブックのクリーンアップ",
                "category_optimization": "サイズの最適化",
                "category_utilities": "書式設定とその他のユーティリティ",
            }
        }
